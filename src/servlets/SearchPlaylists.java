...
public class SearchPlaylists extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String getSongs = "SELECT Playlist.description, Playlist.isPublic, COUNT(*) AS NumSongs "+
                "FROM Playlist, Track, spootify.TrackInPlaylist " +
                "WHERE Playlist.playlistId = spootify.TrackInPlaylist.playlistId " +
                "AND spootify.TrackInPlaylist.trackId = Track.trackId " +
                "AND Playlist.description LIKE ? " +
