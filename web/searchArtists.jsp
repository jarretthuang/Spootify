...
<head>
    <title>Spootify - Search Artists</title>
    <meta charset="utf-8">
                ...
                <div class="table100-head">
                    <table>
                        ...
                        <tr class="row100 head">
                            <th class="cell100 column1">Artist Name</th>
                            <th class="cell100 column2">Artist Genre</th>
                        </tr>
                        </thead>
                    </table>
                </div>
                        ...
                        <c:if test="${artists ne null}">
                            <c:forEach items="${artists}" var="item">
                                <tr class="row100 body">
                                    <td class="cell100 column1">${item.getName()}</td>
                                    <td class="cell100 column2">${item.getGenre()}</td>
                                </tr>
                            </c:forEach>
                        </c:if>
                        </tbody>
